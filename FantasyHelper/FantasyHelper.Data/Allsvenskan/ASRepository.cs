...
namespace FantasyHelper.Data.Allsvenskan
{
    public class ASRepository : IRepository
    {
        private readonly ILogger<ASRepository> _logger;
        private readonly ASDataContext _dbContext;

        public ASRepository(ILogger<ASRepository> logger, ASDataContext dbContext)
        {
            _logger = logger;
        ...
        public async Task AddOrUpdateFixturesAsync(IEnumerable<Fixture> fixtures, CancellationToken cancellationToken = default)
        {
            ...
            else
            {
                ...
                _logger.LogInformation("--> Adding initial load of Allsvenskan fixtures to db...");
        ...
        public async Task AddOrUpdateGameweeksAsync(IEnumerable<Gameweek> gameweeks, CancellationToken cancellationToken = default)
        {
            ...
            else
            {
                ...
                _logger.LogInformation("--> Adding initial load of Allsvenskan gameweeks to db...");
        ...
        public async Task AddOrUpdatePlayersAsync(IEnumerable<Player> players, CancellationToken cancellationToken = default)
        {
            ...
            else
            {
                ...
                _logger.LogInformation("--> Adding initial load of Allsvenskan players to db...");
        ...
        public async Task AddOrUpdateTeamsAsync(IEnumerable<Team> teams, CancellationToken cancellationToken = default)
        {
            ...
            {
                _logger.LogInformation("--> Updating existing Allsvenskan teams in db...");
                _dbContext.Teams.UpdateRange(teams.Where(t =>
                    _dbContext.Teams.Select(te => te.TeamId).Contains(t.TeamId)));

                _logger.LogInformation("--> Adding new Allsvenskan teams to db...");
            ...
            else
            {
                ...
                _logger.LogInformation("--> Adding initial load of Allsvenskan teams to db...");
