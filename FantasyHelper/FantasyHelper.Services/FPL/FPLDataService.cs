...
namespace FantasyHelper.Services.FPL
{
    ...
    public class FPLDataService : BackgroundService, IDataService
    {
        ...
        public FPLDataService(ILogger<FPLDataService> logger, IHttpClientFactory httpClientFactory, IServiceScopeFactory scopeFactory, IMapper mapper, IOptions<FPLOptions> options, ILeagueService leagueService)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            do
            {
                ...
                try
                {
                    ...
                    _db = scope.ServiceProvider.GetRequiredService<IRepository>();
